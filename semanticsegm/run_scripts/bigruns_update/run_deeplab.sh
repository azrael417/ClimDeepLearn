...
APP="python ./deeplab.py  --datadir ${1}/data/ --epochs ${2} --fs local --blocks 2 2 2 4 5 --growth 32 --filter-sz 5 --loss weighted --cluster_loss_weight 0.0  --lr ${3} --optimizer=LARC-Adam  --scale_factor ${4} --gradient-lag ${5} --disable_imsave"
