...
run_dir=${SWORK}/experimental_test_run_nn256_np1536_j144838
mkdir -p ${run_dir}
...
jsrun ${jsrundebug} -n ${nnodes} -g 6 -c 42 -a ${nprocspn} --bind=proportional-packed:7 --launch_distribution=packed stdbuf -o0 ./run_deeplab_deconv_fp16.sh ${scratchdir} 400 0.0064 0.1 0 |& tee out.fp16.lag0.${LSB_JOBID}
