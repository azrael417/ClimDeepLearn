...
run_dir=${SWORK}/GB_scale_final/run_nn${nnodes}_np${nprocs}_j${LSB_JOBID}
mkdir -p ${run_dir}
...
#fp32-lag0
jsrun  -n ${nnodes} -g 6 -c 42 -a ${nprocspn} --bind=proportional-packed:7 --launch_distribution=packed stdbuf -o0 ./run_mascarpone.sh ${scratchdir} 5 0.0001 0.1 0 |& tee out.fp32.lag0.${LSB_JOBID}

#fp32-lag0 
jsrun  -n ${nnodes} -g 6 -c 42 -a ${nprocspn} --bind=proportional-packed:7 --launch_distribution=packed stdbuf -o0 ./run_mascarpone.sh ${scratchdir} 5 0.0001 0.1 1 |& tee out.fp32.lag1.${LSB_JOBID}

#fp16-lag0
jsrun  -n ${nnodes} -g 6 -c 42 -a ${nprocspn} --bind=proportional-packed:7 --launch_distribution=packed stdbuf -o0 ./run_mascarpone_fp16.sh ${scratchdir} 5 0.0001 0.1 0 |& tee out.fp16.lag0.${LSB_JOBID}

#fp16-lag1
jsrun  -n ${nnodes} -g 6 -c 42 -a ${nprocspn} --bind=proportional-packed:7 --launch_distribution=packed stdbuf -o0 ./run_mascarpone_fp16.sh ${scratchdir} 5 0.0001 0.1 1 |& tee out.fp16.lag1.${LSB_JOBID}
