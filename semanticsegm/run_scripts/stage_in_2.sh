...
python ./stagein.py --prefix="data" --input_path=${1} --output_path=${2} --max_files 15360
#python ./stagein.py --prefix="data" --input_path=${1} --output_path=${2} --max_files 960
#python ./stagein.py --prefix="data" --input_path=${1} --output_path=${2} --max_files 240
cp ${1}/stats.h5 ${2}/
