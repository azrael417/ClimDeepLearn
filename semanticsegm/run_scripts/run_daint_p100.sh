...
#run the training
srun -N ${SLURM_NNODES} -n ${SLURM_NNODES} -c 24 -u python -u ./mascarpone-tiramisu-tf-singlefile.py --fs global --datadir ${datadir} --blocks 3 3 4 7 10 --loss weighted --lr 1e-4 --optimizer="LARC-Adam" |& tee out.${SLURM_JOBID}
