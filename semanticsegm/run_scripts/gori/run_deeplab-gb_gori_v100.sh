...
#run the training
${sruncmd} python -u deeplab-tf.py --fs local --datadir_train ${datadir}/train --datadir_validation ${datadir}/validation --cluster_loss_weight 0.0 --scale_factor=0.1 --decoder="deconv1x"  --optimizer opt_type=LARC-Adam,learning_rate=0.0001,gradient_lag=0 --epochs 20 --dtype float16 --batch 2
