...
#fp16-lag1
jsrun  -n ${nnodes} -g 6 -c 42 -a ${nprocspn} --bind=proportional-packed:7 --launch_distribution=packed stdbuf -o0 ./run_mascarpone.sh ${scratchdir} 50 0.0064 0.1 1 |& tee out.fp32.lag1.${LSB_JOBID}
