...
#SBATCH --output=teca_HAPPI_15_wind_tracks_super_relaxed_run1.out
#SBATCH --error=teca_HAPPI_15_wind_tracks_super_relaxed_run1.err
#SBATCH -p debug
#SBATCH -N 4
#SBATCH -t 00:30:00
#SBATCH -C haswell
...
track_file_out=/global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI15_run1_super_relaxed/wind_tracks.bin
