...
module load teca
cd /global/cscratch1/sd/mwehner/machine_learning_climate_data/All-Hist/CAM5-1-0.25degree_All-Hist_est1_v3_run2/h2/

files_regex='.*\.nc$'
track_file=/global/project/projectdirs/dasrepo/gb2018/teca/teca_All-Hist_run2_super_relaxed/tracks.bin
track_file_out=/global/project/projectdirs/dasrepo/gb2018/teca/teca_All-Hist_run2_super_relaxed/wind_tracks.bin
