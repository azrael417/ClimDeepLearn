...
module load teca
cd /global/cscratch1/sd/mwehner/machine_learning_climate_data/HAPPI15/fvCAM5_HAPPI15_run5/h2/
files_regex='.*\.nc$'
track_file=/global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI15_run5_super_relaxed/tracks.bin
track_file_out=/global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI15_run5_super_relaxed/wind_tracks.bin
