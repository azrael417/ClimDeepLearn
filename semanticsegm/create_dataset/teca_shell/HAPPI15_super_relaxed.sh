...
#SBATCH -A dasrepo
#SBATCH --job-name=teca_HAPPI_15_super_relaxed
#SBATCH --time=02:30:00
#SBATCH --nodes=108
#SBATCH --exclusive
#SBATCH --output=teca_HAPPI_15_super_relaxed.out
#SBATCH --error=teca_HAPPI_15_super_relaxed.err
##SBATCH -p debug 
...
srun -n 7300 --cpu_bind=cores --mem_bind=local teca_tc_detect \
    ...
    --candidate_file /global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI15_run1_super_relaxed/candidates.bin \
    --track_file /global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI15_run1_super_relaxed/tracks.bin \
