...
cd /global/cscratch1/sd/mwehner/machine_learning_climate_data/HAPPI20/fvCAM5_HAPPI20_run5/h2/
pwd
...
srun -n 7300 --cpu_bind=cores --mem_bind=local teca_tc_detect \
    ...
    --candidate_file /global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI20_run5_super_relaxed/candidates.bin \
    --track_file /global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI20_run5_super_relaxed/tracks.bin \
