...
srun -n 2920 --cpu_bind=cores --mem_bind=local teca_tc_detect \
    ...
    --candidate_file /global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI15_run1_relaxed/candidates.bin \
    --track_file /global/project/projectdirs/dasrepo/gb2018/teca/teca_HAPPI15_run1_relaxed/tracks.bin \
