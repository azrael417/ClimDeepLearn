...
#main function
def main(input_path_test, channels, label_id, blocks, weights, image_dir, checkpoint_dir, output_graph, tst_sz, loss_type, fs_type, optimizer, batch, batchnorm, dtype, filter_sz, growth, scale_factor):
